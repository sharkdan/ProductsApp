...
module.exports = "<h1>\n  Products\n</h1>\n\n<ul>\n  <li *ngFor=\"let product of products$\">\n    <a routerLink=\"/details/{{ product._id }}\">{{ product.name }}</a>\n    \n    <ul>\n      <li>{{ product.price }}</li>\n    </ul>\n  </li>\n</ul>"
...
var ProductsComponent = /** @class */ (function () {
    ...
    ProductsComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.data.getProducts().subscribe(function (data) { return _this.products$ = data; });
    };
...
module.exports = __webpack_require__(/*! /home/cabox/workspace/ng-proj/src/main.ts */"./src/main.ts");
